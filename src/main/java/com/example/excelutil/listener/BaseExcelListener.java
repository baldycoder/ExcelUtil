package com.example.excelutil.listener;
...
/**
 * @author ：a123145
 * @date ：Created in 2022/7/20 21:03
 * @description：EasyExcel开源类的封装，该类为抽象类，按需实现abstract方法
 * @modified By：`
 * @version: 1.0
 */
@Slf4j
public abstract class BaseExcelListener<T> extends AnalysisEventListener<T> {
     ...
     */
    public abstract boolean validateBeforeAddData(T object);
